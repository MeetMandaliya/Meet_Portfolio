    ...
    <>
      <section>
        <div className="flex flex-col lg:flex-row justify-start lg:justify-start">
          <div className="w-full  pl-[10%] lg:pr-[0%] pr-[10%] h-full">
          ...
          <div className="w-full mt-[20px] lg:mt-[0px] pr-[0px] lg:pr-[10%] sm:pl-[0px]  text-wrap  lg:py-6">
            ...
            {/* <button
              ...
              className="w-[150px] mt-[25px] h-[50px] border rounded-full tracking-[2px] text-white bg-blue-600 font-[700] hover:text-black  lg:ml-[30px] text-[12px]"
            >
              DOWNLOAD CV
            </button> */}
